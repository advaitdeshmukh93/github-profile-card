 ...
 * Maps programming language names to their official hex colors
 * as used on GitHub's language breakdown bars.
 *
...
/** Complete map of language names to hex color codes */
...
/**
 * Gets the hex color for a given programming language.
 * Falls back to a neutral gray (#ccc) if the language isn't found.
 *
 * @param name - Language name (case-sensitive, matches GitHub's naming)
 * @returns Hex color string with # prefix
 */
export function getLangColor(name: string): string {
  return languageColors[name] ?? '#ccc';
}
